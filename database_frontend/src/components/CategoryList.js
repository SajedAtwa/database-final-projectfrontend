...
import image3 from '../static/images/water_damages.png';
import image4 from '../static/images/cameras.png';
import image5 from '../static/images/keyboards.png';
import image6 from '../static/images/charging_port.png';
import image7 from '../static/images/ipad-repair.png';
import image8 from '../static/images/laptop-repair.png';
...
function CategoryList() {
  const categories = [
    ...
    { name: 'Tablet Repair', icon: image7 },
    { name: 'Laptop Repair', icon: image8 },
